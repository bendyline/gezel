...
**Your north star:** Would a discerning user — someone who's used Cursor, Claude Code, ChatGPT, and the polished AI tools shipping right now — open gezel and feel like *this* is the calm, well-organized, file-on-disk-friendly place to put a real team of agents to work? Would they recommend it to a colleague?
...
- **Cursor / Claude Code / Zed** — chat surface that feels native to the developer's workflow rather than a bolt-on
