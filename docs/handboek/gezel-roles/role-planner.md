...
title: The Planner
order: 11
summary: Turns a fuzzy brief into a structured, checkable plan.
---
...
::handboek-role-about{role=planner}

## What they can do

::handboek-role-tools{role=planner scope=default}

### On this device

::handboek-role-tools{role=planner scope=device}

### As models grow

::handboek-role-tools{role=planner scope=tiers}

## Craftbooks they run well

::handboek-craftbook-list{role=planner}
