...
title: The Voorman
order: 2
summary: The foreman — runs one project's crew so you don't have to.
---
...
::handboek-role-about{role=voorman}

## What they can do

::handboek-role-tools{role=voorman scope=default}

### On this device

::handboek-role-tools{role=voorman scope=device}

### As models grow

::handboek-role-tools{role=voorman scope=tiers}

## Craftbooks they run well

::handboek-craftbook-list{role=voorman}
