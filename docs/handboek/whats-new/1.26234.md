...
ogHeadline: Reference libraries your crew can cite
---
...
- New architecture notes: [per-task artifact folders](https://github.com/bendyline/gezel/blob/main/docs/decisions/0008-per-task-artifact-folders.md), the `.gezk` format, knowledge catalogs, project linking, and project retrieval.
