...
ogHeadline: Problems you can hand to a gezel
---
...
Also new: Qwen 3.8 27B (Q4) is now available, with further testing and tuning to follow over the next few days.
...
- **A job's single gezel is now called the Builder** rather than the Ambachtsman. Same gezel, a simpler word.
