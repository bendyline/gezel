...
import { type McpServerSpec, isHttpSpec, isInMemorySpec } from './mcp-spec.js';
import {
  type McpToolWrapper,
...
// there without pulling this module, which imports the wrapper registry). Re-exported so the
// bridge stays the public home for existing callers.
export type {
  HttpMcpServerSpec,
  InMemoryMcpServerSpec,
  McpServerSpec,
  StdioMcpServerSpec,
} from './mcp-spec.js';
export { isHttpSpec, isInMemorySpec, isStdioSpec } from './mcp-spec.js';
