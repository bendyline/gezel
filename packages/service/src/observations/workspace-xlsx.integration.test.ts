 ...
 * or a squisq older than the typed-table export. The fixed, shipped conversion
 * worker uses the trusted-provenance sandbox lane on hosts without an OS-level
 * network boundary, while retaining the remaining sandbox layers.
 */
