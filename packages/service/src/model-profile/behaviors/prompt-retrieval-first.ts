 ...
 * indexed retrieval tools (`search` by meaning, `grep_files` by
...
export const PromptRetrievalFirst: Behavior = {
  ...
  description:
    'Appends a one-line "locate with search/grep_files, don\'t read_file-walk" steer to the workspace-files block, gated on the tools actually being available. No hooks; buildInstructions checks the flag. Tier-default tiny/small/medium.',
};
