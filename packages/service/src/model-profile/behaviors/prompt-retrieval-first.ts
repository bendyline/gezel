 ...
 * indexed retrieval tools (`search_code` by meaning, `grep_files` by
 * pattern) instead of read_file-walking the listing. File-walking is the
...
export const PromptRetrievalFirst: Behavior = {
  ...
  description:
    'Appends a one-line "locate with search_code/grep_files, don\'t read_file-walk" steer to the workspace-files block, gated on the tools actually being available. No hooks; buildInstructions checks the flag. Tier-default tiny/small/medium.',
};
