...
const DEFAULT_RESPONSES: Record<string, unknown> = {
  ...
  listIncompleteKnowledgeDownloads: { incomplete: [] },
  ...
  getNightShiftTally: {
    since: '2026-07-29T22:00:00.000Z',
  ...
  getOpenCodeSetupStatus: {
    ...
    endpointsEnabled: true,
    providerId: 'gezel',
    configPath: '/tmp/gezel-opencode/opencode.json',
    launchCommand: 'OPENCODE_CONFIG=/tmp/gezel-opencode/opencode.json opencode',
    plugin: {
      state: 'not-installed',
      path: '/tmp/opencode-config/plugins/gezel.js',
      canInstall: false,
      canRemove: false,
      canReplace: false,
    },
  ...
  getPiSetupStatus: {
    ...
    endpointsEnabled: true,
    providerId: 'gezel',
    configPath: '/tmp/gezel-pi/models.json',
    extensionPath: '/tmp/gezel-pi/gezel.js',
    extension: {
      state: 'not-installed',
      path: '/tmp/pi-agent/extensions/gezel.js',
      canInstall: false,
      canRemove: false,
      canReplace: false,
    },
    launchCommand: 'pi -e /tmp/gezel-pi/gezel.js',
    bridge: { baseUrl: 'http://127.0.0.1:24680/v1', listening: true, port: 24680 },
    canConfigure: false,
    canRemove: false,
    canRepair: false,
  },
