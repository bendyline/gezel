import type { RewriteTextContext, TransformTextMode } from '../schemas/api.js';
import { SQUISQ_DIALECT_NOTE } from './squisq-dialect.js';
...
export function buildRewritePrompt(opts: RewriteOpts): string {
  const context = opts.context ?? 'generic';
